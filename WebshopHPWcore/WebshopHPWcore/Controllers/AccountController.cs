...
using WebshopHPWcore.Models.AccountViewModels;
    ...
    public class AccountController : Controller
    {
                ...
                if (user != null)
                {
                    if (!await _userManager.IsEmailConfirmedAsync(user))
                    {
                        ModelState.AddModelError(string.Empty,
                                      "Je moet je email bevestigen voordat je kan inloggen, check je mail.");
                        return View(model);
                    }
                }
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                ZipCode = model.ZipCode, City = model.City, Address = model.Address, FirstName = model.FirstName, lastName = model.LastName,
                MiddleName = model.MiddleName, HouseNumber = model.HouseNumber};
